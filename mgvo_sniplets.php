...
class MGVO_SNIPLET {
   ...
   function write_headline($mgvo_headline=""): string {
    ...
    * @return string
    */
   function mgvo_sniplet_vkal(int $vkalnr, int $seljahr): string {
   ...
   function mgvo_sniplet_orte(): string {
   ...
   function mgvo_sniplet_events(): string {
   ...
   function mgvo_sniplet_gruppen(): string {
   ...
   function mgvo_sniplet_abteilungen(): string {
